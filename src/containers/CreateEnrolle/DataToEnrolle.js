...
// export const controlsNames2 = {name:['Фио','text',], dateOfBirth:['Дата рождения', 'date'], address:['Адрес'],number:['Номер телефона'], passNumber:['Номер паспорта']}
export const certificateControlsData = [['Математика','text','math',1],['Физика','text','physics',1],['Химия','text','chemistry',1],['Биология','text','biology',1],['География','text','geography',1],['Русский язык','text','russianLang',1],['Беларусский язык','text','belLang',1],['Беларусская литература','text','belLitr',1],['Русская литература','text','russianLitr',1],['Физическая культура','text','physicalEduc',1],['Иностранный язык','text','english',1],['История Беларуси','text','historyBel',1], ['Всемирная история','text','historyWorld',1], ['Информатика','text','computerScince',1]]
export const faculty = {
  'ФКП': [
    {speaciality: {name :'Автоматизированные системы обработки информации', numberOfPlaces: 4}, exam1: 'математика', exam2: 'программирование', exam3: 'охрана труда', numberOfPlaces: 3},
